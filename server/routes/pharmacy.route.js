...
const {getAll,create,update,deleteOne, migratePharmacy,getAivablePharma,updataLongLat,updateLocation, recordsDoc,getAivablePharmaDayNight} = require('../controller/pharmacyController')
