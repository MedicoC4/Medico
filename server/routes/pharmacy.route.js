...
const {getAll,create,update,deleteOne, migratePharmacy,getAivablePharma,updataLongLat,updateLocation, recordsDoc, verficationPharm} = require('../controller/pharmacyController')
